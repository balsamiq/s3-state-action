...
class S3State {
    constructor(s3, bucket_name, state_json_filepath) {
        ...
        this.state_json_filepath = state_json_filepath;
    }
    ...
    setState(state) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.s3.putObject({ Bucket: this.bucket_name, Key: this.state_json_filepath, Body: JSON.stringify(state) });
        });
    }
}
